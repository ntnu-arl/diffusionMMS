...
from utils.misc import load_single_dat_pretrained_model
from models.backbone.dat import LayerNormProxy, TransformerStage

logger = get_root_logger()


class Single_DAT(nn.Module):
    def __init__(self, img_size=224, patch_size=4, expansion=4,
        ...
        for i in range(4):
            ...
            if i in self.out_indices:
                self.norms.append(LayerNormProxy(dim2))
            else:
    ...
    def init_weights(self, pretrained):
        ...
        if isinstance(pretrained, str):
            load_single_dat_pretrained_model(self, pretrained)
